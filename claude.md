...
PoC-Deployer-System 是一个 Android 安全研究工具，通过利用 `CVE-2024-31317` 系统设置实现 Zygote 进程注入。该工具提供远程 Shell 访问、文件传输、策略管理等功能，主要用于安全研究和系统调试目的。
...
| 💻 **反方向 Shell** | 提供完整的 PTY 终端，支持窗口大小调整 |
...
- [Shizuku](https://github.com/RikkaApps/Shizuku) - 提供 ADB 权限
---
